...
try {
    $queryurl = $null
    $obj = (Invoke-WebRequest -Uri $VisualCppDailyAPI -UseBasicParsing).Content |ConvertFrom-Json
    ...
    $vcobj = (Invoke-WebRequest -Uri $surl -UseBasicParsing).Content |ConvertFrom-Json
